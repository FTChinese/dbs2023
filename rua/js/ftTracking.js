			...
			if (tHref != null && typeof tHref != "undefined" && tHref.length > 0) {
				...
				if (trackLink) {
					...
					if (gaaction && gacategory && galabel) {
						...
						AM_TrackEvent(gaaction, gacategory, galabel, eventValue)
					} else {
...
function AM_TrackEvent(eventAction, eventCategory, eventLabel, eventValue) {
    ...
    if (eventAction=="0% watched" || eventAction=="0% Watched")
	{
		console.log("TVN: calling: AM_TrackEvent: Not Logging: ");
		console.log("TVN: eventAction: " + eventAction);
		...
		if (debug & log)
		{
			...
			console.log("TVN: calling: AM_TrackEvent: Logging:");
			console.log("TVN: eventAction: " + ea);
			console.log("TVN: eventCategory: " + eventCategory);
			console.log("TVN: eventLabel: " + eventLabel);
			console.log("TVN: eventValue: " + eventValue);
		}
		...
		try {
			if (typeof gtag !== "undefined" && log) {
				...
				console.log("TVN: gtag called:", ea, data);
			}
		} catch (e) {
